...
<div id="auth-modal" class="fixed inset-0 flex items-center justify-center bg-black/80 z-[100] hidden">
    <div class="bg-[#121212] w-[400px] p-8 rounded-xl shadow-2xl border border-[#333] relative">
        <button class="js-close-modal absolute top-3 right-4 text-gray-400 text-2xl cursor-pointer">&times;</button>
        
        <div class="flex mb-6">
            <button id="tab-login" class="flex-1 py-2 text-white font-bold cursor-pointer">Đăng nhập</button>
            <button id="tab-register" class="flex-1 py-2 text-gray-500 font-bold cursor-pointer">Đăng ký</button>
        </div>
        ...
        <form id="form-login" class="flex flex-col gap-4">
            ...
            <p id="login-error" class="text-white text-2xl hidden"></p>
            <button class="bg-white text-black font-bold py-2 rounded hover:bg-gray-200 cursor-pointer">Đăng nhập</button>
        </form>
        ...
        <form id="form-register" class="flex flex-col gap-4 hidden">
            ...
            <p id="register-error" class="text-white text-2xl hidden"></p>
            <button class="bg-white text-black font-bold py-2 rounded hover:bg-gray-200 cursor-pointer">Đăng ký</button>
        </form>
    </div>
</div>`;
...
<div id="profile-modal" class="fixed inset-0 bg-black z-[100] hidden overflow-auto">
    <div class="max-w-3xl mx-auto mt-10 p-6">
        <button class="js-close-profile text-white text-xl mb-4 hover:text-gray-200 cursor-pointer">Back</button>
            ...
            <div class="bg-[#1e1e1e] p-6 rounded-lg">
                ...
                <form id="form-update-profile" class="flex flex-col gap-4">
                    <div>
                        ...
                        <input type="email" name="email" value="${user.email}" class="w-full bg-[#121212] text-gray-400 p-3 rounded border border-[#333] cursor-not-allowed" readonly/>
                    </div>
                    <div>
                    ...
                    <button class="bg-white text-black font-bold py-2 px-6 rounded w-max hover:bg-gray-200 cursor-pointer">Cập nhật hồ sơ</button>
                </form>
                ...
                <form id="form-change-pass" class="flex flex-col gap-4">
                    ...
                    <button class="bg-white text-black font-bold py-2 px-6 rounded w-max hover:bg-gray-200 cursor-pointer">Đổi mật khẩu</button>
                </form>
            </div>
        </div>
    </div>
