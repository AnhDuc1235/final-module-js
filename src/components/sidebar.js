function Sidebar() {
    ...
    <div class="js-sidebar flex-col bg-black h-[calc(100vh-64px)] top-[64px] left-0 fixed z-[50] border-r border-[#333] transition-all duration-300">
        <div class="flex flex-col items-baseline gap-[20px] pl-[12px] pt-[20px]">
            <div id="sidebar-home" class="js-home w-[170px] flex flex-row items-center justify-start gap-[10px] border hover:bg-gray-700 pb-[10px] rounded-[10px] ml-[11px] cursor-pointer js-spa-home">
                <i class="fa-solid fa-house text-white text-2xl w-[40px]"></i>
                <a href="/" class="text-white text-[13px] pointer-events-none">Home</a>
            </div>
            
            <div id="sidebar-explore" class="js-explore w-[170px] flex flex-row items-center justify-start gap-[10px] border hover:bg-gray-700 pb-[10px] rounded-[10px] ml-[11px] cursor-pointer">
                <i class="fa-regular fa-compass text-white text-2xl w-[40px]"></i>
                <a href="#" class="text-white text-[13px]">Explore</a>
            </div>

            <div class="js-library w-[170px] flex flex-row items-center justify-start gap-[10px] border hover:bg-gray-700 pb-[10px] rounded-[10px] ml-[11px]">
                <i class="fa-regular fa-bookmark text-white text-2xl w-[40px]"></i>
                <a href="#" class="text-white text-[13px]">Library</a>
            </div>
            
            <div class="js-signin js-login-trigger w-[170px] flex flex-row items-center justify-start gap-[10px] border hover:bg-gray-700 pb-[10px] rounded-[10px] ml-[11px] cursor-pointer">
